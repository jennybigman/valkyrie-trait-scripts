  ...
  library(here)
	...
	# Black Sea bass and Scup do not have max depth (NA), use spawning depth?
	...
	# change Scup depth to aquamaps depth (15-50)
	
	all_traits$MaxDepth[all_traits$Species == "Scup"] <- 50
